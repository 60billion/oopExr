...
public class Bank {
	...
	//constructor
	public Bank(String userName, String phone, String address, int bankNumber) {
	...
	public void wire(String accountNumber,int bankNumber, String toAccountNumber, int amount) {
		...
		pp.setString(1, toAccountNumber.toString());
		...
		String logs12 = "get : "+ amount+" from " +accountNumber+ "/ balance: "+String.valueOf(tolastBalance);
		String sql12 = "insert into "+toid+" (log) values (?)";
		nn = (PreparedStatement) conn.prepareStatement(sql12);
		nn.setString(1, logs12);
		nn.executeUpdate();
